<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $obj->login($_POST['emailid'],$_POST['password']);
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">The Student Portal</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="" method="post" class="signin-form">
		      		<div class="form-group">
		      			<input type="text" class="form-control" placeholder="Email id" required name="emailid">
		      		</div>
	            <div class="form-group">
	          ...
	          <p class="w-100 text-center">&mdash; Or Sign In As &mdash;</p>
	          <div class="social d-flex text-center">
	          	<a href="#" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span> Teacher</a>
	          	<a href="#" class="px-2 py-2 ml-md-1 rounded"><span class="ion-logo-twitter mr-2"></span> Admin</a>
	          </div>
		      </div>
				</div>
			</div>
